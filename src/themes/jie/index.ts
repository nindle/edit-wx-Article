 ...
 * 小帅哥洁洁主题
 */
export const jieTheme: ThemeStyles = {
  code: 'jie',
  name: '小帅哥洁洁',
  styles: {
    base: {
    ...
    container: {
      default: {
        'padding': '16px 20px',
        'margin': '0 0 16px',
        'border': '1px dashed #ff4f79',
        'border-radius': '10px',
      },
    },
  },
  footerContent: '<p style="padding: 0; margin: 0 0 16px; text-align: center; font-size: 14px; color: #666;">关注点赞，好运不断！点个<span style="color: #ff4f79; font-weight: bold;">在看</span>，你最好看🌹</p>',
